				...
				<div class="col-md-12">
					...
					<h1 class="h1Forms">Cadastro - Gerador de Resíduo</h1>
						...
						<div class="form-check form-check-inline">
							...
							<input  checked class="form-check-input" type="radio" name="tipo_cadastro" id="pjuridica" value="pjuridica"> Pessoa Jurídica</input>
							</label>
						</div>
						<div class="form-check form-check-inline">
							<label class="form-check-label">
							<input  class="form-check-input" type="radio" name="tipo_cadastro" id="pfisica" value="pfisica"> Pessoa Física</input>
							</label>
						</div>
						</div>
						<h3 class="">Dados</h3>
						...
						<div class="form-group col-md-4" id="col_cnpj">
							...
							<input  type="text" class="form-control cnpj" id="cnpj" placeholder="00.000.000/0000-00" onChange="valida_cnpj(form_cad_gerador.cnpj);">
						</div>
						<div class="form-group col-md-4" id="col_cpf">
							<label for="cpf" class="col-form-label">CPF</label>
							<input  type="text" class="form-control cpf" id="cpf" placeholder="000.000.000-00" onChange="valida_cpf(form_cad_gerador.cpf);">
						</div>
						...
						<div class="form-group col-md-4">
							...
							<input  type="text" class="form-control" id="nresponsavel" placeholder="Ex.: César Silva, Amauri Jr...">
						</div>
						<div class="form-group col-md-4">
						...
						<div class="form-group col-md-4" id="outro_ramo_option">
							...
							<input  type="text" class="form-control" id="digite_ramo" placeholder="Especifique o Ramo de Negócio">
						</div>
						</div>
						<h3 class="">Contato</h3>
						<div class="form-row">
						<div class="form-group col-md-4">
							...
							<input  type="text" class="form-control phone" id="tel1" placeholder="(21) 6564-0205, (27) 98500-6321...">
						</div>
						<div class="form-group col-md-4">
						...
						<div class="form-group col-md-5">
							...
							<input  type="text" class="form-control" id="rua" placeholder="Ex.: Av. José Silva, Rua São Cosme...">
						</div>
						<div class="form-group col-md-2">
						...
						<div class="form-group col-md-6">
							...
							<input  type="password" class="form-control" id="senha2" onchange="valida_senha();" placeholder="Confirme sua Senha">
						</div>
						</div>
