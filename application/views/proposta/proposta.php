        ...
        <form id="form_proposta" name="form_proposta" action="" method="POST">
            <div>
                <div class="form-check form-check-inline col-md-4">    
                    <input checked class="form-check-input" type="radio" name="cobranca" id="cobrancasim" name="cobrancasim" value="1"  onblur="atualiza_total();"><b> Cobrar para coletar o resíduo</b></input>
                    <br>
                    <input class="form-check-input" type="radio" name="cobranca" id="cobrancanao" name="cobrancanao" value="0"  onblur="atualiza_total();"><b> Pagar para coletar o Resíduo</b></input>
                </div>  
            </div>  
            <br>
            <div class="row">
                <div class="form-group col-md-3 required" id="col_coleta">
                    ...
                    <input required type="number"  class="form-control" id="valor_coleta" name="valor_coleta" placeholder="00,00" onblur="atualiza_total();">
                </div>
                <div class="form-group col-md-3 required" id="col_frete">
                    <label for="valor_frete" class="col-form-label">Valor Frete (R$)</label>
                    <input required type="number" class="form-control" id="valor_frete" name="valor_frete" placeholder="00,00" onblur="atualiza_total();">
                </div>
                <div class="form-group col-md-3" id="col_total">
                    <label for="valor_total" class="col-form-label">Total (R$)</label>
                    <input type="number" class="form-control" id="valor_total" name="valor_total" placeholder="00,00" readonly >
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-12 required" id="col_cnpj">
            ...
            <div class="row">
                <div class="form-group col-md-3 required" id="col_cnpj">
...
<script>
    function atualiza_total(){
        ...
        var valor_coleta = document.getElementById("valor_coleta").value;
