            ...
            <form action="" method="POST">    
                ...
                <div class="form-row">
                    <div class="form-group col-md-2 required">
                        ...
                        <input required type="text" class="form-control cep" id="cep" name="cep" placeholder="000000-000" maxlength="8" value="<?php if (isset($cep)) echo $cep;?>" onblur="pesquisacep(this.value);"  <?php if (isset($obs)) echo "readonly";?>>
                    </div>
                    <div class="form-group col-md-5 required">
                        <label for="Rua" class="col-form-label">Rua</label>
                        <input required type="text" class="form-control" id="rua" name="rua" value="<?php if (isset($rua)) echo $rua;?>" <?php if (isset($obs)) echo "readonly";?>>
                    </div>
                    <div class="form-group col-md-2 required">
                        <label for="numero" class="col-form-label">Número</label>
                        <input required type="number" class="form-control" id="numero" name="numero" value="<?php if (isset($numero)) echo $numero;?>" <?php if (isset($obs)) echo "readonly";?> >
                    </div>
                    <div class="form-group col-md-3">
                        <label for="complemento" class="col-form-label">Complemento</label>
                        <input type="text" class="form-control" id="complemento" name="complemento" value="<?php if (isset($complemento)) echo $complemento;?>" <?php if (isset($obs)) echo "readonly";?> >
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4 required">
                        <label for="bairro" class="col-form-label">Bairro</label>
                        <input required type="text" class="form-control" id="bairro" name="bairro" value="<?php if (isset($bairro)) echo $bairro;?>" <?php if (isset($obs)) echo "readonly";?>>
                    </div>
                    <div class="form-group col-md-4 required">
                    ...
                    <div class="form-group col-md-4 required">
                        ...
                        <select required class="form-control" id="cidade" name="cidade" <?php if (isset($obs)) echo "disabled";?>>
