...
<html lang="pt-br">
  ...
  <body class="fixed-nav sticky-footer bg-light <?php echo ((isset($_COOKIE['menu-vertital-cliente']) and $_COOKIE['menu-vertital-cliente']=='sim')?'sidenav-toggled':''); ?>" id="page-top">
    ...
    <!-- Calendário -->
    <link rel="stylesheet" href="<?php echo base_url('painel/assets/pluguins/datepicker/css/bootstrap-datepicker.min.css'); ?>" type="text/css" />

    <script src="<?php echo base_url('painel/assets/pluguins/datepicker/js/bootstrap-datepicker.min.js'); ?>"></script>
    <script src="<?php echo base_url('painel/assets/pluguins/datepicker/locales/bootstrap-datepicker.pt-BR.min.js'); ?>"></script>
