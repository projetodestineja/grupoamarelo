<form id="form_cad_demanda" action="" method="POST">
		...
		<div class="form-row">
			<div class="form-group col-md-3 required">
				<label for="data_inicio" class="col-form-label">Data de Início do Anúncio:</label>
      ...
      <div class="form-group col-md-3 required">
				<label for="data_validade" class="col-form-label">Data de Expiração do Anúncio:</label>
